...
function Audio(props) {
    ...
    const [play, setPlay] = useState(lastPlayed);
    const [history, setHistory] = useState([]);
    let playerRef = createRef();

    useEffect(() => {
        const src = props.setplaying.epi
            ? props.setplaying.epi.file
            : lastPlayed.src;
        const title = props.setplaying.epi
            ? props.setplaying.epi.title
            : lastPlayed.title;
